...
<div class="row justify-content-start">
 ...
 <div class="col-md-8 esp-left esp-top">
 	<h4 class="esp-top">SISTEMAS CONTRA-INCENDIO</h4>
 	<p>Les ofrecemos las electrobombas principales y tipo jockey que satisfacen los requerimientos de su proyecto. Provisión también de equipos contra-incendio y tableros eléctricos listados UL (Underwriters Laboratiries).</p>
<br>

 	<img   src="img/sistemas-contra-incendio-1.png" alt="">	
