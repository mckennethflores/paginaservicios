...
<head>
	...
	<meta name="application-name" content="Maxboys">
	<meta name="apple-mobile-web-app-title" content="Maxboys">
	<meta name="theme-color" content="#65B22E">
	<meta name="msapplication-navbutton-color" content="#65B22E">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a  class="flex-c-m trans-04 p-lr-25" target="_blank" href="https://api.whatsapp.com/send?phone=51<?php TELEMPRESA ?>&text=Hola%20Maxboys,%20estoy%20interesado%20en%20el%20producto,%20mi%20nombre%20es:"> <i class="fa fa-whatsapp" aria-hidden="true"></i>  <span><?= TELEMPRESA ?></span></a>
						<?php } ?>
					</div>
				</div>
			</div>
			...
			<ul class="topbar-mobile">
				...
				<li>
					<div class="right-top-bar flex-w h-full">
						...
						<a href="tel:<?php trim(TELEFONO) ?>"><?= TELEFONO ?></a>
						<?php } ?>
					</div>
				</li>
			</ul>
