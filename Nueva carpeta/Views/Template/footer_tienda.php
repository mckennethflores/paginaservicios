		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						<?= DIRECCION ?> <br>
						Cel: <a class="linkFooter" href="tel:<?= TELEMPRESA ?>"><?= COUNTRY_CODE." ".TELEMPRESA ?></a><br>
						Cel: <a class="linkFooter" href="tel:<?= TELEMPRESA2 ?>"><?= COUNTRY_CODE." ".TELEMPRESA2 ?></a><br>
					<!-- 	Tel: <a class="linkFooter" href="tel:<?= TELEFONO_FIJO ?>"><?= COUNTRY_CODE." ".TELEFONO_FIJO ?></a><br> -->
			...
			<div class="p-t-40">
				<p class="stext-107 cl6 txt-center">
					...
					<?= NOMBRE_EMPESA; ?> | <?= WEB_EMPRESA; ?> | <a href="https://frsystem.com.pe" target="_blank">FR SYSTEM S.A.C.</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
			</div>
		</div>
