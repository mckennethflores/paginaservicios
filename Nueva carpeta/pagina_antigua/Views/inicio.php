		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner">
                <div class="item active">
                    <img src="<?= media(); ?>/tienda/img/slide3.jpg" width="100%" height="285" alt="" title="" />
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="item ">
                    <img src="<?= media(); ?>/tienda/img/slide1.jpg" width="100%" height="285" alt="" title="" />
                    <div class="carousel-caption">
                    </div>
                </div>
                <div class="item">
                    <img src="<?= media(); ?>/tienda/img/slide2.jpg" width="100%" height="285" alt="" title="" />
                    <div class="carousel-caption">
                    </div>
                </div>
			</div>
	...
	<div class="row ">
		<div class="col-md-12 contenidoBienvenida">
			...
			<ul class="redesSocialesBienvenida">
					 <li> <a href="https://api.whatsapp.com/send?phone=51918515262&amp;text=Quiero%20informacion%20sobre%20los%20productos%20naturales,%20mi%20nombre%20es:"> <img src="<?= media(); ?>/tienda/img/whatsapp.png" width="32" alt=""> 918 515 262</a></li>
					 <li> <a href="https://api.whatsapp.com/send?phone=51930189065&amp;text=Quiero%20informacion%20sobre%20los%20productos%20naturales,%20mi%20nombre%20es:"> <img src="<?= media(); ?>/tienda/img/whatsapp.png" width="32" alt=""> 930 189 065</a></li>
        ...
        <div class="sombra col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 clearfix">
              <ul class="dats">
                ...
                <li class="c-tel"><br>Celular: <a href="mailto:<?= PAIS.CELULAR1 ?>"><?= PAIS.' '.CELULAR1 ?></a>  | <a href="mailto:<?= PAIS.CELULAR2 ?>"><?= PAIS.' '.CELULAR2 ?></a> </li>
